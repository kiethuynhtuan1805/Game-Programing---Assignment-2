...
private:
    ...
    bool mode = 0;
    int stepP1[2];
    const char *runningP1[10] = {"./images/Run1P1.png", "./images/Run2P1.png", "./images/Run3P1.png", "./images/Run4P1.png", "./images/Run5P1.png", "./images/Run6P1.png", "./images/Run7P1.png", "./images/Run8P1.png", "./images/Run9P1.png", "./images/Run10P1.png"};
    int wLeftPlayer = 0;
    int stepP2[2];
    const char *runningP2[10] = {"./images/Run1P2.png", "./images/Run2P2.png", "./images/Run3P2.png", "./images/Run4P2.png", "./images/Run5P2.png", "./images/Run6P2.png", "./images/Run7P2.png", "./images/Run8P2.png", "./images/Run9P2.png", "./images/Run10P2.png"};
    int wRightPlayer = 0;
    float pi;
