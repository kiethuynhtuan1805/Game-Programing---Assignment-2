    ...
    while (!this->isClosed())
    {
            ...
            if (this->started)
            {
                if (this->over)
                {
                    ...
                    if (keystates[SDL_SCANCODE_BACKSPACE])
                    {
                        ...
                        this->over = false;
                        this->rePlay = true;
                        SDL_Surface *imageBg = IMG_Load("./images/Startgame.png");
                ...
                else
                {
                    ...
                    if (this->lastTime != 0)
                    {
                        if (this->lastTime != (60 - floor(this->mTimer->DeltaTime())))
                        {
        ...
        else
        {
            ...
            if (keystates[SDL_SCANCODE_DOWN])
            {
                if (!this->mode)
                {
                    SDL_Surface *imageBg = IMG_Load("./images/Startgame2.png");
                    this->textureBg = SDL_CreateTextureFromSurface(this->renderer, imageBg);
                    SDL_FreeSurface(imageBg);
                    this->mode = !this->mode;
                }
...
void Window::reRender()
{
    ...
    if (this->hitP1[0])
    {
        SDL_Surface *imagePlayerShoot = IMG_Load("./images/ShootP1.png");
    ...
    if (this->hitP2[0])
    {
        SDL_Surface *imagePlayerShoot = IMG_Load("./images/ShootP2.png");
    ...
    else if (!this->started)
    {
        ...
        this->timeCounter("60", this->width / 2 + 20, this->height);
    }
...
void Window::renderOverTime()
{
    ...
    {
        this->rightPlayer[0].w = 180;
        this->rightPlayer[1].w = 180;
        SDL_Surface *imagePlayer_1_1 = IMG_Load("./images/WinP1.png");
        SDL_Surface *imagePlayer_1_2 = IMG_Load("./images/WinP1.png");
        SDL_Surface *imagePlayer_2_1 = IMG_Load("./images/DeadP2.png");
        SDL_Surface *imagePlayer_2_2 = IMG_Load("./images/DeadP2.png");
    ...
    {
        this->leftPlayer[0].w = 180;
        this->leftPlayer[1].w = 180;
        SDL_Surface *imagePlayer_1_1 = IMG_Load("./images/DeadP1.png");
        SDL_Surface *imagePlayer_1_2 = IMG_Load("./images/DeadP1.png");
        SDL_Surface *imagePlayer_2_1 = IMG_Load("./images/WinP2.png");
        SDL_Surface *imagePlayer_2_2 = IMG_Load("./images/WinP2.png");
